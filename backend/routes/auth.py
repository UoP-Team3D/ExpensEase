...
def change_password():
    ...
    current_app.logger.warning("SESSION TOKEN PROVIDED: " + session.sid + "\n")
    current_app.logger.warning("ALL SESSION TOKENS CURRENTLY: " + session_manager.get_active_sessions() + "\n")
